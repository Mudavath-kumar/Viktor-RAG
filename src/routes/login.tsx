          ...
          <form onSubmit={submit} className="mt-6 space-y-4">
            ...
            <label className="block">
              ...
              <div className="mt-1 relative">
                ...
                <input required type={show ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="w-full rounded-full border border-[#051A24]/10 bg-[#f0f0ee] pl-10 pr-12 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#1f5d4f]" />
